...
ALIASES={'Internal Leader Fill Rate':'Internal Leader Fill Rate','Leader Effectiveness':'Leader Effectiveness (Facility Leadership)','Opportunity to Learn and Grow':'Opportunity to Learn and Grow','Forecast and Hire':'Forecast and Hire','Team Member Engagement':'Team Member Engagement','Total Turnover (Rolling 12)':'Total Turnover','Physician Engagement':'Physician Engagement','Annual Active Users':'Digital Tool Utilization','LTR ED':'Patient Experience – ED LTR','LTR Inpatient':'Patient Experience – Inpatient LTR','LTR Med Practice':'Patient Experience – Med Practice LTR','CMS Star Rating':'CMS Overall Hospital Star Rating','Leapfrog Safety Grade':'Leapfrog Hospital Safety Grade','All-Adult Inpatient Mortality':'All-Adult Inpatient Mortality','Length of Stay O/E':'Length of Stay O/E','EBITDA Dollars':'EBITDA $','TOR Dollars':'TOR $','TOR Growth Rate':'TOR Growth Rate','Domestic Spend':'Domestic Spend','Community Impact':'Community Impact','Mission Integration Plan':'Mission Integration Plan'}
